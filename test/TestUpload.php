...
class TestUpload extends TestCase
{
    ...
    {
        $this->upload->getConfigs()->new('test')->image()->setEncryptName(true)->setExtensionByMimes(false)->setUploadPath(__DIR__ . '/test')->setSkipError(true)->save();
    ...
    {
        $_POST['VIDEO'] = 'https://tester.trafsync.com/picture/316107069.gif';
